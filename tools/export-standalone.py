...
surroundings=base64.b64encode((ROOT/'assets/guanque-surroundings.glb').read_bytes()).decode('ascii')
...
assets+='<script id="guanque-surroundings" type="application/octet-stream">'+surroundings+'</script>\n'
