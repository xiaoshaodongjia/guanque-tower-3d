...
function createInteriorExplorer({ THREE, GLTFLoader, scene, renderer, camera, controls, sound, exterior, assetURL,
  ...
  function refreshExterior() {
    ...
    exteriorMaterials((material, original, obj) => {
      ...
      // Closed solids already contain their inward/outward-facing walls. Keep
      // back-face culling when cutting them; the authored roof sheets retain
      // their own DoubleSide setting without exposing hidden solid contacts.
